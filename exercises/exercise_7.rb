...
@added_store = Store.create( name: store_name)
@added_store.valid?
if @added_store.errors.any?
  puts "Error/s prohibited this store from being added:"
  @added_store.errors.full_messages.each do |msg|
    puts "#{ msg }"
  end
end
